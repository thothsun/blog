...
live2d_settings['aboutPageUrl'] = 'https://ai-developer.net';   // 关于页地址, '{URL 网址}'
...
function initModel(waifuPath, type) {
    ...
    $('.waifu-tool .fui-home').click(function () {
        //window.location = 'https://www.ai-developer.net/';
...
function loadTipsMessage(result) {
    ...
    function showHitokoto() {
        switch (live2d_settings.hitokotoAPI) {
            case 'lwl12.com':
                $.getJSON('https://live2d_api.lwl12.com/hitokoto/v1?encode=realjson', function (result) {
